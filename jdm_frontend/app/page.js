...
export default function Home2() {
  ...
  return (
    <Layout headerStyle={2} footerStyle={2}>
      ...
      <Brand1 images={content.affiliations} heading="Accreditations & Certifications" border="true" pagination="false" squareCards={true} />
      <Brand1 images={content.associations} heading="Associations" border="true" pagination="false" squareCards={true} />
